...
| `IMAGE_TAG` | No | `staging` | Image tag (`latest` from `main`, `staging` from `develop`) |
| `REGISTRY` | No | `ghcr.io/l0nelynx/` | Set to empty to build/run fully locally without pulling |
