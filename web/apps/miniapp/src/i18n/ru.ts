...
export const ru: Messages = {
  ...
  "connect.subLinkLabel": "Ссылка подписки",
  ...
  "home.connectAnother": "Как подключиться?",
  ...
  "connect.verifiedTitle": "По подписке уже было подключение",
  "connect.verifiedBody": "Сервер видел соединение по этой подписке. Это не подтверждает подключение именно этого устройства.",
  ...
  "connect.checkAgain": "Проверить подписку",
  "connect.openHelp": "Не получилось подключиться?",
  ...
  "connect.chooseApp": "Выберите приложение",
  "connect.choosePlatform": "На каком устройстве хотите подключиться?",
  "connect.chooseOtherPlatform": "Выберите платформу другого устройства",
  "connect.otherDevice": "Хочу настроить на другом устройстве",
  "connect.otherDeviceShort": "Другое устройство",
  "connect.thisDevice": "Настроить на этом устройстве",
  "connect.detectedDevice": "Это устройство",
  "connect.change": "Изменить",
  "connect.changePlatform": "Изменить платформу",
  "connect.changeApp": "Выбрать другое приложение",
  "connect.guideTitle": "{app} для {platform}",
  "connect.chooseSubscription": "Выберите подписку",
  "connect.chooseSubscriptionHint": "Ссылки будут относиться к выбранной подписке.",
  "connect.copyApp": "Скопировать ссылку на приложение",
  "connect.qrFor": "Показать QR-код: {title}",
  "connect.qrAlt": "QR-код: {title}",
  "connect.qrSubscriptionHint": "Отсканируйте в VPN-приложении, если оно поддерживает QR, или скопируйте ссылку для ручного добавления.",
  "connect.qrExternalHint": "Отсканируйте камерой устройства, на котором настраиваете VPN, чтобы открыть ссылку.",
  "connect.personalLink": "Это ваша личная ссылка для подключения.",
  "connect.qrFailed": "Не удалось создать QR-код. Скопируйте ссылку ниже.",
  "connect.qrLoading": "Создаём QR-код",
  "connect.close": "Закрыть",
  "connect.closeDialog": "Закрыть окно",
  "connect.linkValue": "Полная ссылка",
  "connect.selectLinkHint": "Выделите и скопируйте ссылку вручную.",
  "connect.linkUnavailable": "Не удалось открыть ссылку. Попробуйте ручное добавление.",
  "connect.loadFailed": "Не удалось загрузить подписку",
  "connect.catalogFailed": "Не удалось загрузить приложения",
  "connect.catalogFailedHint": "Ссылку подписки можно скопировать выше.",
  "connect.retry": "Повторить",
  "connect.noPlatforms": "Пока нет доступных платформ. Обратитесь в поддержку.",
  "connect.noApps": "Для этой платформы пока нет приложений. Выберите другую платформу.",
  "connect.transferHint": "Откройте ссылки на устройстве, которое подключаете. Их можно скопировать или передать через QR-код.",
  "connect.useSubscriptionAbove": "На другом устройстве добавьте ссылку подписки из блока выше вручную или через QR в VPN-приложении.",
};
