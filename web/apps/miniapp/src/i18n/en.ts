...
export const en: Messages = {
  ...
  "home.connectAnother": "How to connect?",
  ...
  "connect.verifiedTitle": "This subscription has been used",
  "connect.verifiedBody": "The server has seen a connection for this subscription. This does not confirm a connection from this particular device.",
  ...
  "connect.checkAgain": "Check subscription",
  "connect.openHelp": "Having trouble connecting?",
  ...
  "connect.chooseApp": "Choose an app",
  "connect.choosePlatform": "Which device would you like to connect?",
  "connect.chooseOtherPlatform": "Choose the other device’s platform",
  "connect.otherDevice": "I want to set up another device",
  "connect.otherDeviceShort": "Another device",
  "connect.thisDevice": "Set up this device",
  "connect.detectedDevice": "This device",
  "connect.change": "Change",
  "connect.changePlatform": "Change platform",
  "connect.changeApp": "Choose another app",
  "connect.guideTitle": "{app} for {platform}",
  "connect.chooseSubscription": "Choose a subscription",
  "connect.chooseSubscriptionHint": "Links will use the selected subscription.",
  "connect.copyApp": "Copy app link",
  "connect.qrFor": "Show QR code: {title}",
  "connect.qrAlt": "QR code: {title}",
  "connect.qrSubscriptionHint": "Scan in a VPN app that supports QR codes, or copy the link to add it manually.",
  "connect.qrExternalHint": "Scan with the device you are setting up to open the link.",
  "connect.personalLink": "This is your personal connection link.",
  "connect.qrFailed": "Could not create a QR code. Copy the link below.",
  "connect.qrLoading": "Generating QR code",
  "connect.close": "Close",
  "connect.closeDialog": "Close dialog",
  "connect.linkValue": "Full link",
  "connect.selectLinkHint": "Select and copy the link manually.",
  "connect.linkUnavailable": "Could not open the link. Try adding it manually.",
  "connect.loadFailed": "Could not load your subscription",
  "connect.catalogFailed": "Could not load the apps",
  "connect.catalogFailedHint": "You can still copy your subscription link above.",
  "connect.retry": "Try again",
  "connect.noPlatforms": "No platforms are available yet. Please contact support.",
  "connect.noApps": "No apps are available for this platform yet. Choose another platform.",
  "connect.transferHint": "Open these links on the device you are connecting. Copy them or scan a QR code.",
  "connect.useSubscriptionAbove": "On the other device, add the subscription link above manually or scan its QR code in the VPN app.",
};
