...
export const liquidGlassConfig: ConfigProviderProps = {
  theme: {
    ...
    components: {
      ...
      Drawer: {
        colorBgElevated: "rgba(20, 20, 30, 0.92)",
      },
      Input: {
        activeShadow: "none",
        colorBgContainer: "rgba(255, 255, 255, 0.06)",
      ...
      Select: {
        colorBgContainer: "rgba(255, 255, 255, 0.06)",
        colorBgElevated: "rgba(28, 28, 38, 0.92)",
        optionSelectedBg: "rgba(124, 156, 255, 0.18)",
      },
      Table: {
        ...
        rowHoverBg: "rgba(124, 156, 255, 0.08)",
      ...
      Menu: {
        ...
        darkItemSelectedBg: "rgba(124, 156, 255, 0.18)",
