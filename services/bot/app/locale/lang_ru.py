...
promo_already_used_text = "Ты уже использовал этот промокод ранее."

promo_active_exists_text = "У тебя уже активирован промокод. Используй его при оплате, прежде чем активировать новый."

promo_referral_new_only_text = "Этот промокод действует только для новых пользователей — у тебя уже были покупки."

promo_deeplink_applied_text = "🎁 Промокод активирован! Скидка <b>{discount}%</b> будет учтена при оплате подписки."
...
miniapp_welcome = (
    ...
    "🇳🇱 Нидерланды\n\n"
    "<b>Инструкция:</b>\n"
    "• Откройте <a href=\"{miniapp_tg_url}\">приложение</a>\n"
    "• Купите подписку или активируйте пробную\n"
    "• Нажмите кнопку «Подключить»\n"
    "• Следуйте указаниям на экране, выбрав свою платформу"
)

btn_open_app = "🚀 Открыть приложение"
btn_settings_info = "⚙️ Настройки и инфо"
