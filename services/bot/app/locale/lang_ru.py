...
promo_success_text = "Промокод применён! На баланс начислено <b>{credits}</b> кредитов (дней)."
...
promo_active_exists_text = "Ты уже использовал этот промокод ранее."

promo_referral_new_only_text = "Этот промокод действует только для новых пользователей — у тебя уже были покупки."

promo_deeplink_applied_text = "🎁 Промокод активирован! На баланс начислено <b>{credits}</b> кредитов."

btn_pay_credits = "💎 Оплатить кредитами ({credits})"
