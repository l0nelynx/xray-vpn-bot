...
promo_invite_text = """<b>Приглашай друзей — получай баллы</b>

Твой промокод: <code>{promo_code}</code>

<b>Как это работает:</b>
1. Поделись промокодом с друзьями
2. Друг получает <b>{invite_grant}</b> 🪙 при активации
3. За каждые 30 дней покупок по твоему коду — <b>{reward_points}</b> 🪙 тебе

<b>Твоя статистика:</b>
• Куплено приглашёнными: {days_purchased} дн.
• Получено баллов: {points_rewarded} 🪙"""
...
По твоему промокоду совершена покупка — на баланс начислено <b>{reward_points}</b> 🪙.

Всего куплено приглашёнными: {total_days} дн.
Всего получено баллов: {total_rewarded} 🪙"""
